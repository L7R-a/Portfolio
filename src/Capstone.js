                  ...
                  <Card.Body>
                    <Card.Title className="text-center">The Story</Card.Title>
                        <Row className="scrollable-row">
                            <p> My capstone project involves collaborating with a team to develop software for the Department of History at UCF. The software will provide a visual representation of relationships among individuals in early modern America.</p>
                            <br></br>
                            <p>The department has a database containing over 3,000 letters. Our team's objective is to create a software solution that extracts data from this database and generates a graph/network representation of the connections between individuals as revealed by the letters, where the graph's nodes are the individuals and the edges are the letters. In addition to the graph we also need to display the details, statistics, and biography of the individuals and the letters.</p>

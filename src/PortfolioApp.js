...
const PortfolioApp = ({title, subtitle, githubLink, storyText, challenges, learningText,}) => {
    return(
      ...
      learningText={[
            ...
            " Additionally, something very useful that I learned was to efficiently implement and reuse my own components in project, something that was very useful to make pages that are similar format but different text content.",

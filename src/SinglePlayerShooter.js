...
const SinglePlayerShooter = () => {
  return (
      <ProjectDisplay
        ...
        storyText={[
          "This project, a single player 3D shooter game, began as a Udemy course. The course was designed to teach the fundamentals of shooter games in Unreal Engine and C++ by showing students the capabilities of both blueprints and coding together. I chose this tutorial to gain hands-on experience in vectors and AI in Unreal Engine.",
                    ...
                    const learningText = {[
                      {
                        ...
                        details: [
                          ...
                          "Designed pistol, smgs, and assault riffle weapons",

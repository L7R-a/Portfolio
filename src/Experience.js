            ...
            <Row>
              <Col md={12} className="rightColAbout">
                ...
                <Card className="experienceCard">
                  {/* <Card.Img className= "imageExperience" variant="top" src={Formal} /> */}
                  <Card.Body>
                    <Card.Title className="cardTitle">Programming Languages</Card.Title>
                    <Row>
                    <Col md= {6}>
                      <p className="cardTitle"> Proeficient</p>
                ...
                <Card className="experienceCard">
                  ...
                  <Card.Body>
                    ...
                    <Row>
                      <ListGroup  className="list-group">
                      <ListGroup.Item className="list-group-item-no-border">
                          <PiSealCheckFill  size={24} /> Data Structures and Algortihms I & II
                        </ListGroup.Item> 
                        <ListGroup.Item className="list-group-item-no-border">
